...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', pizza).then(function (res) {
    ...
    toast().success('Pizza added to cart', '')["with"]({
      shape: 'square',
      duration: 2000,
      speed: 1000,
      positionX: 'end',
    ...
    toast().danger('Something went wrong', '')["with"]({
      shape: 'square',
      duration: 2000,
      speed: 1000,
      positionX: 'end',
...
} //Remove alert after x second from customers order page
...
socket.on('orderUpdated', function (data) {
  ...
  toast().success('Order Updated', '')["with"]({
    shape: 'square',
    duration: 2000,
    speed: 1000,
    positionX: 'end',
